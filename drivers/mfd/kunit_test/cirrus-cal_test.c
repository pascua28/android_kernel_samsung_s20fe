...
static void cs35l41_test_cal_add(struct test *test)
{
	const char *suffix_wrong = "_x";
	int ret;

	test_info(test, "%s: start", __func__);
	ret = cirrus_cal_amp_add(NULL, suffix_wrong, NULL, 0);
 ...
 */
static int cirrus_cal_test_init(struct test *test)
{
	return 0;
}
 ...
 */
static void cirrus_cal_test_exit(struct test *test)
{
}
 ...
 * below.
 */
static struct test_case cirrus_cal_test_cases[] = {
	/*
	...
	TEST_CASE(cs35l41_test_cal_add),
#endif
	{},
};
 ...
 * ...;
 */
static struct test_module cirrus_cal_test_module = {
	.name = "cirrus_cal_test",
	.init = cirrus_cal_test_init,
	.exit = cirrus_cal_test_exit,
	.test_cases = cirrus_cal_test_cases,
};
 ...
 */
module_test(cirrus_cal_test_module);
